...
public class UssGetOperationsTest {
    private static final Logger LOGGER = LoggerFactory.getLogger(UssGetOperationsTest.class);
    ...
    @Test
    public void shouldGetOperationDetailsSuccessfullyFromAUss() throws IOException {
        //given
    ...
    @Test
    public void shouldReturnA400whenTheGetOperationIsRequestedWithIncorrectData() throws IOException {
        //given
    ...
    @Test
    public void shouldReturnA403WhenTheScopeIsIncorrectToGetTheOperations() throws IOException {
        //given
        String operationId = ussOperationId;
        requestUrlParams.add(operationId);
    ...
    @Test
    public void shouldReturnA404WhenTheDataIsNotPresentWithTheUssForTheOperationId() throws IOException {
        //given
